...
namespace Hangfire.Dashboard.Management
{
    public class CustomHangfireLanguage : System.Resources.ResourceManager
    {
        ...
        public CustomHangfireLanguage(ResourceManager resourceManager, System.Func<string, CultureInfo, string> translateFunc)
        {
        ...
        public override string GetString(string name, CultureInfo culture)
        {
            ...
            {
                return this._translateFunc(name, culture);
            }
            else if (name == "JobsSidebarMenu_Enqueued")
            {
                return "队列";
            }
            ...
            else if (System.Text.RegularExpressions.Regex.IsMatch(name, "Reason_Background job has exceeded latency timeout of (?<timeoutInSeconds>\\d+) second(s)"))
            {
