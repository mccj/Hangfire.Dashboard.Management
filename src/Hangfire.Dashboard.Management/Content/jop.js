...
function loadHttpJobModule() {
    ...
    var pauseButton = '<button class="js-jobs-list-command btn btn-sm btn-warning" data-url="/hangfire/recurring/pause" data-loading-text="暂停中"  data-confirm="您确定要暂停所选的全部作业吗？" disabled="disabled">' +
        '<span class="glyphicon glyphicon-pause"></span>' + '暂停' +
        '</button>';
    $('.btn-toolbar-top button:last').before(pauseButton);

    var repeatButton = '<button class="js-jobs-list-command btn btn-sm btn-success" data-url="/hangfire/recurring/repeat" data-loading-text="恢复中"  data-confirm="您确定要恢复所选的全部作业吗？" disabled="disabled">' +
        '<span class="glyphicon glyphicon-repeat"></span>' + '恢复' +
        '</button>';
    $('.btn-toolbar-top button:last').before(repeatButton);

    var addButton = '<a class="btn btn-sm btn-default" href="/hangfire/management">' +
        '<span class="glyphicon glyphicon-plus"></span>' + '添加' +
        '</a>';
    $('.btn-toolbar-top button:last').before(addButton);
}
